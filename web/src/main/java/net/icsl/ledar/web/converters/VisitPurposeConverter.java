...
@ManagedBean(name = "visitPurposeConverterBean")
@FacesConverter(value = "visitPurposeConverter")
public class VisitPurposeConverter implements Converter {
    ...
    public Object getAsObject(FacesContext ctx, UIComponent component, String value) {
        ...
        Root<VisitPurpose> lcdaObj = criteria.from(VisitPurpose.class);
        if (!value.contains("Select")) {
            criteria = criteria.multiselect(lcdaObj.get("id"), lcdaObj.get("purposeName"), lcdaObj.get("created")).where(cb.equal(lcdaObj.get("id"), new Long(value)));
    ...
    public String getAsString(FacesContext fc, UIComponent uic, Object o) {
        ...
        VisitPurpose lcda = ((VisitPurpose) o);
