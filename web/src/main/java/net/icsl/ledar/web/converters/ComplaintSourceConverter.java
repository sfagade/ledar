...
@ManagedBean(name = "complntSourceConverterBean")
@FacesConverter(value = "complntSourceConverter")
public class ComplaintSourceConverter implements Converter {
    ...
    public Object getAsObject(FacesContext ctx, UIComponent component, String value) {
        ...
        if (!value.contains("Select")) {
            criteria = criteria.multiselect(lcdaObj.get("id"), lcdaObj.get("sourceName"), lcdaObj.get("created")).where(cb.equal(lcdaObj.get("id"), new Long(value)));
    ...
    public String getAsString(FacesContext fc, UIComponent uic, Object o) {
        ...
        ComplaintSources lcda = ((ComplaintSources) o);
